          ...
          <div class="flex flex-col gap-y-10">
            <div>
              ...
              <h3 class="text-xl font-bold text-indigo-950">Rp
                {{ $subscribeTransaction->total_amount }}</h3>
            </div>
            ...
            <div>
              ...
              <h3 class="text-xl font-bold text-indigo-950">{{ $subscribeTransaction->created_at }}
              </h3>
            </div>
            <div>
              <p class="text-sm text-slate-500">Subscription Start At</p>
              <h3 class="text-xl font-bold text-indigo-950">
                {{ $subscribeTransaction->subscription_start_date }}
              </h3>
            </div>
            <div class="">
              <p class="text-sm text-slate-500">Student</p>
              <h3 class="text-xl font-bold text-indigo-950">{{ $subscribeTransaction->user->name }}
              </h3>
            </div>
          </div>
          <div>
