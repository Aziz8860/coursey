<x-guest-layout>
  <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
    ...
    <div class="mt-4">
      ...
      <x-text-input id="occupation" class="mt-1 block w-full" type="text" name="occupation" :value="old('occupation')"
    ...
    <div class="mt-4">
      ...
      <x-text-input id="avatar" class="mt-1 block w-full" type="file" name="avatar" :value="old('avatar')" required
        autocomplete="avatar" />
