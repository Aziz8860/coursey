...
<body class="text-black font-poppins pt-10 pb-[50px]">
        ...
        <div class="flex flex-col gap-3">
          <div
            ...
            <a href="{{ route('front.details', $course) }}">
              <p
                class="font-semibold text-white group-hover:text-white transition-all duration-300">
                Course
                Trailer</p>
            </a>
          </div>
          ...
          @forelse($course->course_videos as $video)
            <div
              ...
              <a href="{{ route('front.learning', [$course, 'courseVideoId' => $video->id]) }}">
                <p
                  class="font-semibold group-hover:text-white transition-all duration-300 text-black">
                  {{ $video->name }}</p>
              </a>
            </div>
          @empty
  ...
  <section id="Video-Resources" class="flex flex-col mt-5">
    <div class="max-w-[1100px] w-full mx-auto flex flex-col gap-3">
      <h1 class="title font-extrabold text-[30px] leading-[45px]">{{ $course->name }}
        2024</h1>
    ...
    <div
      ...
      <div
        class="tablink font-semibold text-lg h-[47px] transition-all duration-300 cursor-pointer hover:text-[#FF6129]"
        ...
        <div id="Screenshots" class="flex flex-col gap-3">
          ...
          <div class="grid grid-cols-4 gap-5">
            <div
              ...
              <img src="  {{ asset('assets/thumbnail/image.png') }}"
