  ...
  <section class="max-w-[1100px] w-full mx-auto absolute -translate-x-1/2 left-1/2 top-[170px]">
    <div class="flex flex-col gap-[30px] items-center">
      ...
      <div class="flex flex-col text-white text-center">
        ...
        <p class="text-lg -tracking-[2%]">Catching up the on demand skills and high paying career
          this year</p>
      </div>
          ...
          <div class="flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-4">
              ...
              <div class="flex gap-3">
                ...
                <p class="text-[#475466]">Unlock all course badges to enhance career profile to
                  apply a job after completed</p>
              </div>
            </div>
          </div>
          <a href=""
        ...
        <div class="flex flex-col rounded-3xl p-8 gap-[30px] bg-white h-fit">
          <div class="flex flex-col gap-5">
            <div class="flex flex-col gap-4">
              ...
              <p class="text-[#475466] text-lg">All access to more than 20,000 online courses to
                grow your future career easily</p>
            </div>
            <div class="flex flex-col gap-1">
