...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        // pake resource jadi biar otomatis dibuat routenya
        // Route::resource automatically creates multiple routes handling the standard actions associated with a resource
        // semuanya jadi perlu role owner untuk ngeaksesnya
        Route::resource('categories', CategoryController::class)->middleware('role:owner|teacher'); // admin.categories.index
